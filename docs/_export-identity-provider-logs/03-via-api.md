...
- You must request `date_start` and `date_end`  with nanosecond epochs, use <https://www.epochconverter.com/>
- ![alt text](/assets/images/export-identity-provider-logs/epoch.png)
