...
1. An initial overview page for your new tutorial.
...
1. An images directory specific to your new tutorial
...
1. A new entry at the bottom of the `_config.yml` file.
