...
5. **Build**: To build your site locally, execute the following command:
...
1. **Navigate to the publishing source**: Change your working directory to the root of your Jekyll site (named `docs`):

```shell
  cd path/to/your/docs
```

1. **Install Dependencies**: Install the required dependencies for your Jekyll site:

```shell
rake setup
```

1. **Build Your Site**: To build your site locally, execute the following command:
...
1. **Preview Your Site**: Once the build process completes, open your web browser and navigate to [http://localhost:4000](http://localhost:4000) to preview your Jekyll site.
